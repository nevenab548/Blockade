...
class Main:
    ...
    def starting_state(self):
        ...
        self.x1 = int(input("Enter coordinate for first pawn for player one: Position X: "))
        self.x2 = int(input("Position Y: "))
        self.y1 = int(input("Enter coordinate for second pawn for player one: Position X: "))
        self.y2 = int(input("Position Y: "))
